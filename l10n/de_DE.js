OC.L10N.register(
    ...
    "No administrator has set an email address" : "Niemand von der Administration hat eine E-Mail-Adresse angegeben",
    "Data Request" : "Datenanforderung",
    "Request your data from the admins" : "Ihre Daten von der Administration anfordern",
    "Enable your users to request an export or deletion of their data. According options are added to the personal settings section. Administrators will be notified by email about the request." : "Erlaubt Ihren Nutzern einen Export oder die Löschung ihrer Daten anzufordern. Passende Optionen werden in der persönlichen Seite der Nutzer angezeigt. Die Administration wird per E-Mail über die Anforderung benachrichtigt.",
    "Account" : "Konto",
    "You can request an export of your data or account deletion from the system administrator. This can take up to 30 days." : "Sie können einen Export Ihrer Daten oder die Konto-Löschung bei der Systemadministration anfordern. Das kann bis zu 30 Tage dauern.",
