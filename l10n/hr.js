OC.L10N.register(
    ...
    "Hello %s," : "Pozdrav %s,",
    "The user %s, identified by user id \"%s\", has requested an export of their personal data. Please take action accordingly." : "Korisnik %s s korisničkim imenom „%s” zatražio je izvoz svojih osobnih podataka. Poduzmite odgovarajuće radnje.",
    "Account deletion request" : "Zahtjev za brisanje računa",
    "The user %s, identified by user id \"%s\", has requested to delete their account. Please take action accordingly." : "Korisnik %s s korisničkim imenom „%s” zatražio je brisanje svog računa. Poduzmite odgovarajuće radnje.",
