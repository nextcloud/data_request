OC.L10N.register(
    ...
    "Hello %s," : "Merhaba %s,",
    "The user %s, identified by user id \"%s\", has requested an export of their personal data. Please take action accordingly." : "%s kullanıcısı (\"%s\" kodlu), kişisel verilerini dışa aktarma isteğinde bulundu. Lütfen gerekli işlemleri yapın.",
    "Account deletion request" : "Hesap silme isteği",
    "The user %s, identified by user id \"%s\", has requested to delete their account. Please take action accordingly." : "%s kullanıcısı (%s kodlu), hesabının silinmesi isteğinde bulundu. Lütfen gerekli işlemleri yapın.",
