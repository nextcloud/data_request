OC.L10N.register(
    ...
    "Hello %s," : "Hei %s",
    "The user %s, identified by user id \"%s\", has requested an export of their personal data. Please take action accordingly." : "Käyttäjä %s, jonka tunniste on \"%s\", on pyytänyt henkilökohtaisten tietojen vientiä. Toimithan pyynnön mukaisesti.",
    "Account deletion request" : "Tilin poistopyyntö",
    "The user %s, identified by user id \"%s\", has requested to delete their account. Please take action accordingly." : "Käyttäjä %s, jonka tunniste on \"%s\", on pyytänyt tilinsä poistamista. Toimithan pyynnön mukaisesti.",
