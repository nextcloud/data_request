OC.L10N.register(
    ...
    "Hello %s," : "Witaj %s,",
    "The user %s, identified by user id \"%s\", has requested an export of their personal data. Please take action accordingly." : "Użytkownik %s, zidentyfikowany jako \"%s\", zażądał eksportu swoich danych osobowych. Podejmij odpowiednie działania.",
    "Account deletion request" : "Prośba usunięcia konta",
    "The user %s, identified by user id \"%s\", has requested to delete their account. Please take action accordingly." : "Użytkownik %s, zidentyfikowany jako \"%s\", zażądał usunięcia swojego konta. Podejmij odpowiednie działania.",
