OC.L10N.register(
    ...
    "Hello %s," : "Kedves %s,",
    "The user %s, identified by user id \"%s\", has requested an export of their personal data. Please take action accordingly." : "%s felhasználó (felhasználóazonosítója „%s”) a személyes adatainak exportálását kérte. Tegye meg a lépéseket ennek megfelelően.",
    "Account deletion request" : "Fióktörlési kérés",
    "The user %s, identified by user id \"%s\", has requested to delete their account. Please take action accordingly." : "%s felhasználó (felhasználóazonosítója „%s”) a fiókja törlését kérte. Tegye meg a lépéseket ennek megfelelően.",
