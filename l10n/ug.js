OC.L10N.register(
    ...
    "Enable your users to request an export or deletion of their data. According options are added to the personal settings section. Administrators will be notified by email about the request." : "ئىشلەتكۈچىلىرىڭىزنىڭ سانلىق مەلۇماتلىرىنى ئېكسپورت قىلىشنى ياكى ئۆچۈرۈشىنى تەلەپ قىلىڭ. تاللاشلار شەخسىي تەڭشەك بۆلىكىگە قوشۇلدى. باشقۇرغۇچىغا بۇ تەلەپ ھەققىدە ئېلېكترونلۇق خەت ئارقىلىق ئۇقتۇرۇش قىلىنىدۇ.",
    "Account" : "ھېسابات",
    "You can request an export of your data or account deletion from the system administrator. This can take up to 30 days." : "سىستېما باشقۇرغۇچىدىن سانلىق مەلۇماتلىرىڭىزنى ياكى ھېساباتنى ئۆچۈرۈۋېتىشنى تەلەپ قىلسىڭىز بولىدۇ. بۇنىڭغا 30 كۈن ۋاقىت كېتىدۇ.",
    "Request data export" : "سانلىق مەلۇمات ئېكسپورتىنى تەلەپ قىلىڭ",
    "Request account deletion" : "ھېسابات ئۆچۈرۈشنى تەلەپ قىلىڭ"
},
