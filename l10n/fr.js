OC.L10N.register(
    ...
    "Hello %s," : "Bonjour %s,",
    "The user %s, identified by user id \"%s\", has requested an export of their personal data. Please take action accordingly." : "L'utilisateur·ice %s, identifié·e par l'id \"%s\", a demandé une exportation de ses données personnelles. Merci de bien vouloir agir en conséquence.",
    "Account deletion request" : "Demande du suppression de compte",
    "The user %s, identified by user id \"%s\", has requested to delete their account. Please take action accordingly." : "L'utilisateur·ice %s, identifié·e par l'id \"%s\", a demandé la suppression de son compte. Merci de bien vouloir agir en conséquence.",
    ...
    "Enable your users to request an export or deletion of their data. According options are added to the personal settings section. Administrators will be notified by email about the request." : "Permet à vos utilisateur·ices de demander l'exportation ou la suppression de leurs données. Les options sont ajoutées à la section des paramètres personnels. Les administrateur·ices seront notifié·es par courriel de la demande.",
    "Account" : "Compte",
    ...
    "The user %s, identified by user id \"%s\", has requested to delete the account. Please take action accordingly." : "L'utilisateur·ice %s, portant l'identifiant \"%s\", a demandé la suppression de son compte. Merci de bien vouloir agir en conséquence."
},
