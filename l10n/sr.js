OC.L10N.register(
    ...
    "Hello %s," : "Поштовање %s,",
    "The user %s, identified by user id \"%s\", has requested an export of his personal data. Please take action accordingly." : "Корисник %s, са корисничком идентификацијом \"%s\" је затражио извоз његових/њених личних података. Молимо предузмите потребне радње.",
    "Account deletion request" : "Захтев за брисање налога",
    "The user %s, identified by user id \"%s\", has requested to delete the account. Please take action accordingly." : "Корисник %s, са корисничком идентификацијом \"%s\" је затражио брисање налога. Молимо предузмите потребне радње.",
