OC.L10N.register(
    ...
    "The user %s, identified by user id \"%s\", has requested an export of his personal data. Please take action accordingly." : "用戶 %s（用戶 ID \"%s\"）已請求匯出其個人資料。請採取相對的措施。",
    "The user %s, identified by user id \"%s\", has requested to delete the account. Please take action accordingly." : "用戶 %s（ID “%s”）已請求刪除其帳號。請採取相對的措施。"
},
"nplurals=1; plural=0;");
