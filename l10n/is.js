OC.L10N.register(
    ...
    "Hello %s," : "Halló %s,",
    "The user %s, identified by user id \"%s\", has requested an export of their personal data. Please take action accordingly." : "Notandinn %s, með notandaauðkennið \"%s\", hefur beðið um útflutning á notandaupplýsingum sínum. Vinsamlegast gríptu til viðeigandi ráðstafana sem fyrst.",
    "Account deletion request" : "Beiðni um eyðingu á aðgangi",
    "The user %s, identified by user id \"%s\", has requested to delete their account. Please take action accordingly." : "Notandinn %s, með notandaauðkennið \"%s\", hefur beðið um eyðingu á notandaaðgangi sínum. Vinsamlegast gríptu til viðeigandi ráðstafana sem fyrst.",
