OC.L10N.register(
    ...
    "Hello %s," : "こんにちは %s さん、",
    "The user %s, identified by user id \"%s\", has requested an export of their personal data. Please take action accordingly." : "ユーザー%s、アカウントIDは\"%s\" が、個人データのエクスポートを要求しています。速やかに対応してください。",
    "Account deletion request" : "アカウントの削除要求",
    "The user %s, identified by user id \"%s\", has requested to delete their account. Please take action accordingly." : "ユーザー%s、ユーザーIDは\"%s\" が、アカウントの削除を要求しています。 速やかに対応してください。",
