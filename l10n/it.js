OC.L10N.register(
    ...
    "Hello %s," : "Ciaoo %s,",
    "The user %s, identified by user id \"%s\", has requested an export of his personal data. Please take action accordingly." : "L'utente %s, identifcato dall'ID utente \"%s\", ha richiesto un'esportazione dei suoi dati personali. Agisci di conseguenza.",
    "Account deletion request" : "Richiesta di eliminazione account",
    "The user %s, identified by user id \"%s\", has requested to delete the account. Please take action accordingly." : "L'utente %s, identifcato dall'ID utente \"%s\", ha richiesto di eliminare l'account. Agisci di conseguenza.",
